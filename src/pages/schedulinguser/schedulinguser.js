  ...
  return (
    ...
    >
      <ScrollView>
        ...
        <View style={[styles.schedulingForm, {marginTop: 17}]}>
          <View>
            <Text style={styles.schedulingLabel}>O que você precisa?</Text>
            <TextInput style={[styles.schedulingInput, {marginBottom: 25}]} placeholder="Descreva o serviço" autoCapitalize={'sentences'} keyboardType={'default'} />

            <Text style={styles.schedulingLabel}>Em qual área?</Text>
            <TextInput style={[styles.schedulingInput, {marginBottom: 25}]} placeholder='Escolha a área' autoCapitalize={'sentences'} keyboardType={'default'} />
